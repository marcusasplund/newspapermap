...
var tableid = 552892;
var zoom = 3;
var latlng = new google.maps.LatLng(37.0, -5.6);
var suggestion;
var ne; var sw;
var tabkey;
var regex1;
...
'<img src="yellow-dot.png" width="16" height="16"/> <a href="http://newspapermap.co.uk">English - UK</a><br />' +
...
$.ajax({
type: "GET",
url: "http://maps-api-ssl.google.com/maps/suggest?hl=en-US&gl=en-US&v=3&json=b&auth=ABQIAAAAALakLdjjlTHt7ZswQah3VRQhzk0B9PQtvkZRIRmh2TMWxDe2yRSKq5BP3oJYSnI5FTbfuS_Rdg8dEQ&src=1,2&num=5&numps=5&callback=handleResponse&q=" + $('#search').val() + "&cp=" + $('#search').val().length,
dataType: "script",
queue: "SUG1",
cancelExisting: true
});
