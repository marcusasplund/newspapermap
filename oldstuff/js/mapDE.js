...
var tableid = 552892;
var zoom = 7;
var latlng = new google.maps.LatLng(50.94, 9.73);
var suggestion;
var ne; var sw;
var tabkey;
var regex1;
...
{
if (map.getZoom() < 2){
alert("Man kann nicht verkleinern weiter");
map.setZoom(2);
}
}
});
...
'<img src="red-dot.png" width="16" height="16"/> <a href="http://newspapermap.com/ES.html">Spanisch/Español</a><br />' +
'<img src="yellow-dot.png" width="16" height="16"/> <a href="http://newspapermap.com">Englisch/English-US</a><br />' +
'<img src="blue-dot.png" width="16" height="16"/> Deutsch<br />' +
'<img src="purple-dot.png" width="16" height="16"/> Russisch<br />' + 
'<img src="pink-dot.png" width="16" height="16"/> <a href="http://newspapermap.com/JA.html">Japanisch/日本</a><br />' +
'<img src="white-dot.png" width="16" height="16"/> Französisch<br />' +
'<img src="ltblue-dot.png" width="16" height="16"/> Portugiesisch<br />' +
'<img src="orange-dot.png" width="16" height="16"/> Arabisch<br />' +
'<img src="green-dot.png" width="16" height="16"/> Andere<br />' +
'<small>● - e-zeitung</small>';
...
$.ajax({
type: "GET",
url: "http://maps-api-ssl.google.com/maps/suggest?hl=de&gl=de&v=3&json=b&auth=ABQIAAAAALakLdjjlTHt7ZswQah3VRQhzk0B9PQtvkZRIRmh2TMWxDe2yRSKq5BP3oJYSnI5FTbfuS_Rdg8dEQ&src=1,2&num=5&numps=5&callback=handleResponse&q=" + $('#search').val() + "&cp=" + $('#search').val().length,
dataType: "script",
queue: "SUG1",
cancelExisting: true
});
