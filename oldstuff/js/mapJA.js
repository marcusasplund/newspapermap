...
var tableid = 552892;
var zoom = 8;
var latlng = new google.maps.LatLng(35.89, 137,78);
var suggestion;
var ne; var sw;
var tabkey;
var regex1;
...
'<img src="pink-dot.png" width="16" height="16"/> 日本<br />' +
'<img src="yellow-dot.png" width="16" height="16"/> <a href="http://newspapermap.com">英語 English/US</a><br />' +
'<img src="red-dot.png" width="16" height="16"/> <a href="http://newspapermap.com/ES.html">スペイン語/Español</a><br />' +
'<img src="white-dot.png" width="16" height="16"/> フランス<br />' +
'<img src="ltblue-dot.png" width="16" height="16"/> ポルトガル語<br />' +
'<img src="blue-dot.png" width="16" height="16"/> <a href="http://zeitungskarte.de">ドイツ 語 Deutsch</a><br />' +
'<img src="purple-dot.png" width="16" height="16"/> ロシア<br />' + 
'<img src="orange-dot.png" width="16" height="16"/> アラビア語<br />' +
'<img src="green-dot.png" width="16" height="16"/> 他の言語<br />' +
'<small>● - デジタル新聞</small>';
...
$.ajax({
type: "GET",
url: "http://maps-api-ssl.google.com/maps/suggest?hl=ja&gl=ja&v=3&json=b&auth=ABQIAAAAALakLdjjlTHt7ZswQah3VRQhzk0B9PQtvkZRIRmh2TMWxDe2yRSKq5BP3oJYSnI5FTbfuS_Rdg8dEQ&src=1,2&num=5&numps=5&callback=handleResponse&q=" + $('#search').val() + "&cp=" + $('#search').val().length,
dataType: "script",
queue: "SUG1",
cancelExisting: true
});
