...
var tableid = 552892;
var zoom = 6;
var latlng = new google.maps.LatLng(22.55, 78.66);
var suggestion;
var ne; var sw;
var tabkey;
var regex1;
...
'<img src="yellow-dot.png" width="16" height="16"/> <a href="http://newspapermap.com">English - US</a><br />' +
'<img src="red-dot.png" width="16" height="16"/> <a href="http://newspapermap.com/ES.html">Spanish/Español</a><br />' +
'<img src="white-dot.png" width="16" height="16"/> French<br />' +
'<img src="ltblue-dot.png" width="16" height="16"/> Portuguese<br />' +
'<img src="blue-dot.png" width="16" height="16"/> <a href="http://zeitungskarte.de">German/Deutsch</a><br />' +
'<img src="purple-dot.png" width="16" height="16"/> Russian<br />' + 
'<img src="pink-dot.png" width="16" height="16"/> <a href="http://newspapermap.com/JA.html">Japanese/日本</a><br />' +
'<img src="orange-dot.png" width="16" height="16"/> Arabic<br />' +
'<img src="green-dot.png" width="16" height="16"/> Other<br />' +
...
$.ajax({
type: "GET",
url: "http://maps-api-ssl.google.com/maps/suggest?hl=en-UK&gl=en-UK&v=3&json=b&auth=ABQIAAAAALakLdjjlTHt7ZswQah3VRQhzk0B9PQtvkZRIRmh2TMWxDe2yRSKq5BP3oJYSnI5FTbfuS_Rdg8dEQ&src=1,2&num=5&numps=5&callback=handleResponse&q=" + $('#search').val() + "&cp=" + $('#search').val().length,
dataType: "script",
queue: "SUG1",
cancelExisting: true
});
